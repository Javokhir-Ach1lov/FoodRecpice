package uz.javokhir_apps.foodrecpice;
...
import uz.javokhir_apps.foodrecpice.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageList = {R.drawable.osh, R.drawable.manti, R.drawable.norin, R.drawable.dimlama, R.drawable.somsa, R.drawable.manti, R.drawable.manti1};
